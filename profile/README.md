...
A vetted list of tools an AI agent can call end-to-end. The bar is strict — if a step needs KYC, dashboard configuration, a sales call, or any click-to-enable gate, the tool doesn't make the list.

### [ai-building-tutorials](https://github.com/thebuilderweekly/ai-building-tutorials)
